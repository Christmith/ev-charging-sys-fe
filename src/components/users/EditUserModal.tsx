...
export function EditUserModal({
    ...
    const updatedUser: WebUser = {
      ...
      assignedStationId:
        formData.role === "StationOperator"
          ? formData.assignedStationId[0] || undefined
          : undefined,
  ...
  const handleStationToggle = (stationId: string, checked: boolean) => {
    setFormData((prev) => ({
      ...prev,
      assignedStationId: checked
        ? [...prev.assignedStationId, stationId]
        : prev.assignedStationId.filter((id) => id !== stationId),
    }));
  };
              ...
              availableStations.length > 0 && (
                <div className="space-y-2">
                    ...
                    {availableStations.map((station) => (
                      ...
                      >
                        <Checkbox
                          ...
                          checked={formData.assignedStationId.includes(
                            station.id
                          )}
                  ...
                  <div className="text-xs text-muted-foreground">
                    {formData.assignedStationId.length} station(s) selected
                  </div>
                </div>
              )}
          </div>
